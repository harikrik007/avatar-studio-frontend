...
// an Anam face is picked from a catalogue while building the agent, so
// there is nothing to manage and only one place to be.

// Inline so the sidebar gets its one icon without pulling in an icon
// package for a single glyph. 16px, stroke-only, currentColor -- it
// inherits the link's muted/active colour for free.
function AgentsIcon() {
  return (
