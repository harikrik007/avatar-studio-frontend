...
// Two steps here, not v1's three: the avatar is picked from a catalogue
// rather than created, so "Create avatar" is not a step anyone takes.

const STEPS = ["Build agent", "Go live"] as const;
...
export default function FlowRail({
  ...
  const done = [hasAgent, hasLiveAgent];
